    ...
    <section className='w-full h-auto relative flex flex-col p-4 mb-10'>
      <div className='w-full relative flex justify-center items-center'>
        <div className='w-[90%] h-auto absolute px-5 py-4 bg-white z-10 rounded-md'>
          <p className='font-normal text-xs text-center md:text-sm text-gray-700'>Vertigolabs is a crowdfunding platform authorized and regulated by the <strong>CNMV</strong> and registered with <strong>the registration number 20</strong>. Please, carefully read the <Link className='text-blue-400 hover:underline' href='/informacion-basica-inversor'>Basic Investor Information</Link> before investing.</p>
        </div>
      </div>
