...
const ButtonFilter = ({ handleSetFilter, children, filterWanted, filter }: Props) => {
  return (
    <button
      ...
      className={clsx('flex text-gray-500 justify-center items-center text-xs whitespace-nowrap px-5 py-2 hover:bg-[#666666] hover:border-none font-semibold uppercase hover:text-white border',
